...
export default function Contact() {
  return (
    <section id="contact" className="bg-orange-50 py-20 text-center from-white px-6">
      ...
      <p className="mt-4 flex items-center justify-center gap-2"><LinkedinIcon size={20} className="text-orange-500" /><span className="font-medium">LinkedIn :</span>
        <a
      ...
      <p className="mt-4 flex items-center justify-center gap-2"><GithubIcon size={20} className="text-orange-500" /><span className="font-medium">GitHub :</span>
