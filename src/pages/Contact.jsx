...
export default function Contact() {
  return (
    <section id="contact" className="bg-orange-50 py-20 text-center from-white px-10">
      <h2 className="text-3xl font-bold text-orange-600 py-5 ">Contact</h2>
       <div className="max-w-3xl mx-auto bg-white shadow-xl rounded-3xl p-8 space-y-6 text-gray-700">

  {/* Email */}
  <div className="flex items-center gap-4">
    <Mail size={20} className="text-orange-500" />
    <span className="font-semibold min-w-[90px]">Email :</span>
    <a href="mailto:taibizineb96@gmail.com" className="text-orange-500 break-all">
  ...
  <div className="flex items-center gap-4">
    ...
    <a href="tel:+212652841972" className="text-orange-500">
      +212 6 52 84 19 72
    </a>
  </div>
  ...
  {/* LinkedIn */}
  <div className="flex items-center gap-4">
    <LinkedinIcon size={20} className="text-orange-500" />
  ...
  {/* GitHub */}
  <div className="flex items-center gap-4">
    <GithubIcon size={20} className="text-orange-500" />
