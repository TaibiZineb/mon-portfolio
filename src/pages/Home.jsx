...
export default function Home() {
  return (
  <section id="home" className="min-h-screen flex flex-col justify-center items-center text-center px-6 py-20 bg-orange-100" >
 <h1 className="text-4xl md:text-6xl font-bold flex flex-col md:flex-row items-center md:items-start gap-3 animate-fadeIn text-center md:text-left"><Hand size={35}className="text-orange-500" />Bonjour, je suis <span className="text-orange-500">TAIBI Zineb</span></h1>
